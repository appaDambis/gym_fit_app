...
class _HomePageState extends State<HomePage> {
  List menuArr = [
    {"name": "Meals", "image": "assets/img/non_veg_recipe_1.jpg", "tag": "1"},
    {"name": "Cardio", "image": "assets/img/running.jpg", "tag": "2"},
    {"name": "Exercises", "image": "assets/img/chest_dips.jpg", "tag": "3"},
    {"name": "Schedule", "image": "assets/img/schedule.png", "tag": "4"},
  ];
            ...
            UserAccountsDrawerHeader(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/img/lat_pulldowns.jpg"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
  ...
  Future<void> _pickImageFromGallery() async {
    ...
    if (pickedFile != null) {
      ...
      try {
        ...
        // Update UI to reflect new profile photo
        setState(() {
          _user = _auth.currentUser;
